...
INSERT INTO applications (category, company, year_application, bank, bfr, type_facility, name_facility, collateral, profit_rate, rate_tenure, status, app_details, progress, date_doc_sent, date_updated, total_requested, total_approved) VALUES
  ('COMPANY', 'MUAZ FORCE SDN BHD', 2022, 'Standard Chartered', '6.45%', 'TERM LOAN', 'PEMULIH GGS', '80% SJPP, 20% FD', '3.75%', '7 YEARS', 'DONE', 'DISBURSED & READY TO USE', 100, '2022-06-09', '2026-06-30', 2000000, 2000000),
  ('COMPANY', 'MUAZ FORCE SDN BHD', 2023, 'Bank Rakyat', '6.58%', 'OVERDRAFT', 'CM Cash Line-i', '80% SJPP, 20% FD', 'BFR + 1%', 'MONTHLY / 5 YEARS', 'DONE', 'DISBURSED & READY TO USE', 100, '2023-03-04', '2026-06-30', 3000000, 2000000),
  ('COMPANY', 'MUAZ FORCE SDN BHD', 2024, 'Bank Rakyat', '6.58%', 'CAPITAL FINANCING', 'WCF-i', '80% SJPP, 20% FD', 'BFR + 0.75%', 'MONTHLY / 7 YEARS', 'DONE', 'DISBURSED & READY TO USE', 100, '2024-08-12', '2026-06-30', 2000000, 2000000),
  ('COMPANY', 'AFRA SERVICES SDN BHD', 2022, 'Bank Rakyat', '6.58%', 'OVERDRAFT', 'CM Cash Line-i', '80% SJPP, 20% FD', 'BFR + 1%', 'MONTHLY', 'DONE', 'DISBURSED & READY TO USE', 100, '2022-07-14', '2026-06-30', 800000, 800000),
  ('COMPANY', 'FIRST ALLIED SECURITY SERVICES SDN BHD', 2022, 'Bank Rakyat', '6.58%', 'OVERDRAFT', 'CM Cash Line-i', '80% SJPP, 20% FD', 'BFR + 1%', 'MONTHLY', 'DONE', 'DISBURSED & READY TO USE', 100, '2022-10-07', '2026-06-30', 500000, 500000),
  ('COMPANY', 'FIRST ALLIED SECURITY SERVICES SDN BHD', 2022, 'Maybank', '6.40%', 'OVERDRAFT', 'OD-i', '80% SJPP, 20% FD', 'BFR + 1.25%', 'MONTHLY', 'DONE', 'DISBURSED & READY TO USE', 100, '2022-10-10', '2026-06-30', 1000000, 500000),
  ('COMPANY', 'NELANG SECURITY SDN BHD', 2022, 'MBSB Bank', '6.50%', 'TERM LOAN', 'PEMULIH', '80% SJPP, 20% FD', '3.75%', '7 YEARS', 'DONE', 'DISBURSED & READY TO USE', 100, '2022-12-14', '2026-06-30', 800000, 500000),
  ('COMPANY', 'MSA SINAR ENTERPRISE', 2022, 'SME Bank', '6.75%', 'TERM LOAN', 'PEMULIH', '80% SJPP, 20% FD', '3.75%', '7 YEARS', 'DONE', 'DISBURSED & READY TO USE', 100, '2022-01-04', '2026-06-30', 1000000, 200000),
  ('COMPANY', 'MUAZ MAJU SDN BHD', 2022, 'Affin Bank', '6.56%', 'OVERDRAFT', 'AFFIN Tawarruq Cash Line-i', '80% SJPP', 'BFR + 1.5%', 'MONTHLY', 'DONE', 'DISBURSED & READY TO USE', 100, '2022-06-18', '2026-06-30', 5000000, 2500000),
  ('COMPANY', 'COMMITTED SECURITY SDN BHD', 2022, 'MBSB Bank', '6.50%', 'TERM LOAN', 'PEMULIH', '80% SJPP, 20% FD', '3.75%', '7 YEARS', 'DONE', 'DISBURSED & READY TO USE', 100, '2022-06-24', '2026-06-30', 550000, 550000);
